...
public class hybrid extends AppCompatActivity implements CarCycleAdapter.ClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        handler.post(new Runnable() {
            ...
            public void run() {
                ...
                recyclerView.setAdapter(new CarCycleAdapter(getApplicationContext(),carsList, hybrid.this));
            }
        });
        ...
        faves.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent i = new Intent(hybrid.this, Faves.class);
                startActivity(i);
            }
        });
        ...
        reserves.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i = new Intent(hybrid.this, Reserves.class);
                startActivity(i);
            }
        });
    }
                    ...
                    public void onClick(View v) {
                        ...
                        continueBtn.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                ...
                                Intent intent = new Intent(hybrid.this, MapActivity.class);
                                Gson gson = new Gson();
