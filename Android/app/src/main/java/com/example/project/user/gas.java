...
public class gas extends AppCompatActivity implements CarCycleAdapter.ClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        handler.post(new Runnable() {
            ...
            public void run() {
                ...
                if (putData.startPut()) {
                    if (putData.onComplete()) {
                        ...
                        for (String car: cars) {
                            ...
                            try {
                                newCar = new Car(carArray[0],carArray[1],carArray[2],carArray[3],carArray[4],carArray[5],carArray[6],carArray[7],carArray[8]);
                ...
                recyclerView.setAdapter(new CarCycleAdapter(getApplicationContext(),carsList, gas.this));
            }
        });
        ...
        faves.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent i = new Intent(gas.this, Faves.class);
                startActivity(i);
            }
        });
        ...
        reserves.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i = new Intent(gas.this, Reserves.class);
                startActivity(i);
            }
        });
    }
                    ...
                    public void onClick(View v) {
                        ...
                        continueBtn.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                ...
                                Intent intent = new Intent(gas.this, MapActivity.class);
                                Gson gson = new Gson();
